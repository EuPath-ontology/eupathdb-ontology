These notes are for the EDITORS of eupath
...
Make sure you have an ID range in the [idranges file](eupath-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [eupath-edit.owl](eupath-edit.owl)

** DO NOT EDIT eupath.obo OR eupath.owl in the top level directory **

[../../eupath.owl](../../eupath.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/eupath-ontology/eupathdb-ontology) for details.
 ...
 * [eupath-idranges.owl](eupath-idranges.owl)
...
This generates derived files such as eupath.owl and eupath.obo and places
 ...
 * https://github.com/eupath-ontology/eupathdb-ontology/releases
 * https://github.com/eupath-ontology/eupathdb-ontology/releases/new
...
what is in the `owl:versionIRI` of the derived eupath.owl (`data-version` in
eupath.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/eupath.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/eupath/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/eupath-ontology/eupathdb-ontology.svg?branch=master)](https://travis-ci.org/eupath-ontology/eupathdb-ontology)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/eupath-ontology](https://travis-ci.org/profile/eupath-ontology)
 2. click the "Sync account" button
 3. Click the tick symbol next to eupathdb-ontology
