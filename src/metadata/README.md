 ...
 * [eupath.yml](eupath.yml)
     * Determines how your purl.obolibrary.org/obo/eupath/ redirects will be handled
     ...
     * Paste in the contents of [eupath.yml](eupath.yml)
 ...
 * [eupath.md](eupath.md)
     ...
     * Paste in the contents of [eupath.md](eupath.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
